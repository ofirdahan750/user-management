// npx ng test --include='**/local-storage.service.spec.ts' --no-watch --browsers=ChromeHeadless
...
describe('LocalStorageService', () => {
  ...
  it('should clear all items', () => {
    ...
    service.setItem(StorageKeys.USER, 'user');
    service.clear();
    expect(service.getItem(StorageKeys.TOKEN)).toBeNull();
    expect(service.getItem(StorageKeys.USER)).toBeNull();
  });
});
